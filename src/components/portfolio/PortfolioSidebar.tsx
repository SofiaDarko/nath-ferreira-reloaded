    ...
    <aside className="w-16 h-full border-r border-border flex flex-col items-center justify-between py-5 flex-shrink-0 bg-bg relative z-50">
      ...
      <nav className="flex flex-col -my-px">
        {([
          ...
          <div
            key={page.id}
            className={`writing-vertical transform rotate-180 font-display text-[10px] font-normal tracking-[0.18em] uppercase cursor-pointer py-6 px-0 transition-all border-b border-[hsl(0,0%,17%)] last:border-b-0 ${
              currentPage === page.id
